...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || "Negotiation is not to have a deal,It is to have a better deal than the bottom line.",

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Chloe Jia', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'NUS MiM⭐', // 作者简介
  ...
  // 作废配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || '/chloe.jpg', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
